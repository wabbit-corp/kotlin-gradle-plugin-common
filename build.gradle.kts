...
// managed-integrity-v1: cqEKggcJoGs
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-gradle-plugin-common", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-gradle-plugin-common")
        description.set("Shared Gradle-side helper library for Wabbit Kotlin compiler-plugin Gradle plugins.")
        url.set("https://github.com/wabbit-corp/kotlin-gradle-plugin-common")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-gradle-plugin-common")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-gradle-plugin-common.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-gradle-plugin-common.git")
        }
    }
}
...
dependencies {
    ...
    testImplementation("org.jetbrains.kotlin:kotlin-gradle-plugin:2.3.10")
...
kover {
    ...
    //             // title.set("kotlin-gradle-plugin-common Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
plugins.withId("org.jetbrains.dokka") {
    afterEvaluate {
        extensions.findByType(DokkaExtension::class)?.apply {
            moduleName.set("kotlin-gradle-plugin-common")
            ...
            dokkaSourceSets.named("main").configure {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-gradle-plugin-common/tree/master/src/main/kotlin")
